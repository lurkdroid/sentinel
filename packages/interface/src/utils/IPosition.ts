...
export function strPosition(position: IPosition): string {
...
export function _strPosition(position: IPosition, lastAmount: BigNumber): string {
...
function calcPrice(position: IPosition): string {
