...
import { IChainData, getChainData } from "../utils";
...
type ActionType =
  | {
    ...
    parsedAddress?: StateType['parsedAddress']
  ...
  switch (action.type) {
    ...
    case 'SET_WEB3_PROVIDER':
      return {
        ...
        parsedAddress: action.parsedAddress,
...
export const useWallets = () => {
  ...
  const connect = useCallback(async function () {
    ...
    dispatch({
      ...
      web3Provider,
      address,
      parsedAddress: `${address.slice(0, 5)}...${address.slice(-5)}`,
